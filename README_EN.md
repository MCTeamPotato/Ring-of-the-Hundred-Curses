...
9. [x] Weak Stomach: Raw meat gives debuffs. kl
10. [x] Weaponless: Cannot mine hard blocks. kl
...
14. [x] Heavy Shackles: Wearing equipment reduces movement speed. kl
15. [x] Weakened Strikes: Deals less damage to enemies. kl
16. [x] Soul Suppression: Reduces experience point gain. kl
17. [x] Fragile Body: Fall damage cannot be mitigated. kl
18. [x] Fragile Armor: Reduces armor and toughness given by armor. kl
19. [x] Sluggish Hands: Reduces mining speed. kl
20. [x] Lonely Master: Cannot tame mobs. kl
21. [x] Lost Direction: Maps and compasses become useless. kl
22. [x] Weak Magic Constitution: Cannot use high-level enchantments. kl
23. [x] Weak Swimmer: Reduces swimming speed, and drowning damage increases with depth. kl
24. [x] Cafeteria Lady: Respawn anchors charge with a random number of uses. 暮雨雨
25. [x] Endless Quiz: Enchanting the same weapon repeatedly reduces its enchantment level. 暮雨雨
26. [x] Friend or Foe: A trident with Loyalty has a chance to damage the player when returning. 暮雨雨
27. [x] Incompetent Thief: Opening loot chests in Pillager Outposts or Villages spawns Pillagers and Villagers. 暮雨雨
28. [x] Blood and Flesh: Each time you take damage, you receive additional damage based on a percentage of your maximum health. 初见
29. [x] Horde Mind: After killing a mob, there is a chance to spawn the same mob in place. 初见
30. [x] Focus Disturbance: Attacks, placements, and crafting have a chance to fail. 初见
31. [x] Neurological Degeneration: Negative effects are applied after respawning. 初见, kl
32. [x] Phantom gift: The phantom will be refreshed every night, and the phantom will airdrop monsters. 简笔
...
38. [x] Weak Wall: Shield durability drains when holding a shield. 鲁邦
39. [x] Regeneration Ban: Instant healing effects you receive will be delayed. 鲁邦
40. [x] Potion Conflicts: Each time you gain a positive buff, existing buffs shorten while debuffs are extended. 鲁邦
...
43. [x] Time Rift: Every time you throw an Ender Pearl, Endermites spawn to attack you. rinko
...
56. [x] Shattered Eye: Ender Eyes always break upon use. 暮雨雨
...
61. [x] Food Coma: Eating has a delay, during which no actions can be performed. cos45
...
68. [x] Bleeding Wound: Taking damage has a chance to cause continuous health loss. Christen
69. [x] Feast or Famine: Having too low or too high saturation applies debuffs. Christen
70. [x] Pulmonary Fibrosis: Reduces maximum oxygen. Christen
71. [x] Bargaining Power: The higher the health of a trading entity, the more expensive its trades. Christen
72. [x] Hollow Stomach: Reduces maximum saturation. kl
73. [x] Distant Deflection: Introduces universal damage cap and ranged damage resistance. rinko
74. [x] PTSD: If the player was previously killed by a mob, encountering it again causes a debuff. Textrue
75. [x] Curse of Misfortune: The player's dropped items are calculated multiple times, taking the worst result. 咒神灰
...
84. [x] Overburdened: When your inventory holds too many items, your movement speed is reduced and fall damage is increased. kl
85. [x] Shattered Portal: Portals become one-time use; they explode after being used. kl
86. [x] Unbalanced Weapon: Each time you attack, there’s a chance your weapon’s attack power will decrease. kl
...
94. [x] Overhealing: Using a healing item may cause you to be unable to heal again for a short time. kl
95. [x] Patterned Assault: You must alternate different attack methods to damage certain creatures. kl
...
98. [x] Terrible Cook: Cooked meals have a chance to turn into mysterious stew that inflicts a debuff. kl
99. [x] Deafening: You don’t always need a Sculk Shrieker to summon the Warden. kl
100. [x] Ending Moment: The appearance of the ender dragon will play better and better remixes and add post-processing effects. kl
...
4. [ ] Boxed In: Falling from a height greater than 4 blocks has a chance to result in death. MCMostWolf
